...
CNVmatrix_input <- readRDS('DNAmatrix.rds')
RNAmatrix_input <- readRDS('RNAmatrix.rds')

# user-defined
ResultsCCNMF <- Integrate_CCNMF(CNVmatrix_input, RNAmatrix_input, 2,
...
############## Plot Subclones of scDNA #################
scDNA_genes_matrix <- readRDS('scDNA_gene_matrix.rds')
